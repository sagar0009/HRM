<%@ Page Title="" Language="C#" MasterPageFile="RecMaster.Master" AutoEventWireup="true" CodeBehind="Interview.aspx.cs" Inherits="FinalP.Interview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="tbl">
        <tr>
            <td class="tblhead" colspan="2">&nbsp;Interview Calls</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="GVInterview" runat="server" EmptyDataText="No Records Found" AllowPaging="false" CssClass="center" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                                <asp:CheckBox ID="CkSts" OnCheckedChanged="CkSts_CheckedChanged" Checked='<%# Eval("IsInterviewPss") == DBNull.Value ? false : Eval("IsInterviewPss") %>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
    ...
    <div>
       ...
       <%-- <div class="header">
        ...
        <div class="center">
            <asp:GridView ID="GVInterview" EmptyDataText="No Records Available" runat="server" CssClass="center" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False">
                <Columns>
                    <asp:TemplateField HeaderText="ReceivalID">
                        <ItemTemplate>
                            <asp:Label ID="LblRecId" runat="server" Text='<% # Eval("ReceivalId") %>'></asp:Label>
                ...
                $("body").on("click", "#btnExport", function () {
                    html2canvas($('[id*=GVInterview]')[0], {
                        onrendered: function (canvas) {
                            ...
                            pdfMake.createPdf(docDefinition).download("InterviewCalls.pdf");
                        }
                    });
                });
            </script>
        ...
        <div align="center">
            <asp:Button ID="BtnDone" Width="20%" OnClick="BtnDone_Click" runat="server" Text="Done" CssClass="center" />
            <asp:Button ID="BtnBack" Width="20%" OnClick="BtnBack_Click" runat="server" Text="Back" CssClass="center " />
            <input type="button" style="width: 20%" id="btnExport" class="center" value="Export To Pdf" />
        </div>--%>
